...
export const metadata: Metadata = {
  title: "Nazalan Muaffari – Software Engineer & Digital Business",
  description: "Official portfolio of Nazalan Muaffari. Software Engineer, Digital Business Builder, and E-Commerce Merchant.",
